...
import { Play, RotateCcw, Search, Snowflake, Trash2 } from "lucide-react";
import { api, formatAddress, makeValue, toTuxError, valueNumber } from "../lib/api";
 ...
 */
export function Scanner({ game, onNotice }: ScannerProps) {
  const { t } = useI18n();
